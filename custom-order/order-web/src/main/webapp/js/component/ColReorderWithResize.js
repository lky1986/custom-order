    ...
    ColReorder.prototype = {
        ...
        */
        "_fnMouseListener": function (i, nTh) {
            ...
            thead.unbind('mousemove.ColReorder');
            thead.unbind('mousedown.ColReorder');
                ...
                thead.bind('mousemove.ColReorder', function (e) {
                    ...
                    if (that.dom.drag === null && that.dom.resize === null) {
                        ...
                        if (Math.abs(e.pageX - Math.round(offset.left + nLength)) <= 5) {
                            $(nThTarget).css({ 'cursor': 'ew-resize' });
                            // catch gaps between cells
                            //$(nTable).css({'cursor' : 'ew-resize'});
...
//                this.s.dt.oFeatures.bAutoWidth = false;
            ...
            }).bind('mouseup.ColReorder', function (e) {
                setTimeout(function () {
        ...
        */
        "_fnMouseMove": function (e) {
            ...
            if (this.dom.resize) {
                ...
                var nThNext ;
                if($(nTh).next().width()<=this.s.minResizeWidth){
//                    $(nTh).next().width(this.s.minResizeWidth);
                    nThNext = $(nTh).next().next();
                }
                nThNext = $(nTh).next();
